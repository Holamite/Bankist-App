...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    // whwn 0 secs, stop timer and log out user
    if (time === 0) {
      clearInterval(timer);
...
btnLogin.addEventListener('click', function (e) {
  ...
  if (currentAccount?.pin === +inputLoginPin.value) {
    ...
    const options = {
      ...
      minute: 'numeric',
      day: 'numeric',
      month: 'numeric', //long, short, 2-digits
      year: 'numeric',
      // weekday: 'long', //long, short, 2-digits
    };
...
// To read a value number out of a string
...
// Minimum Number
console.log(Math.min(5, 10, '23px', 11, 2));
console.log(Math.PI * Number.parseFloat('10px') ** 2);

// Generating random Number
console.log(Math.trunc(Math.random() * 6) + 1);

// Function for generation Number
...
console.log(Math.trunc(45.99099));
...
console.log(233890948746789000987465678390832783783999999837n);
console.log(BigInt(233890948746789000987465678390832783783999999837));

// OPerators
console.log(10000n + 10000n);
console.log(23455555543456665444444477776555555555555n * 10000000000n);

const huge = 20398830934884930984n;
const num = 23;
...
console.log(new Date('Apr 26 2023 10:53:36'));
...
const pizzaTimer = setTimeout(
  (ing1, ing2) => console.log(`Here is your pizza with ${ing1} and ${ing1} 🍕`),
  3000,
  ...ingredients
);
